...
# load data
soc.data <- read.csv(file = "dat/ppk23_mmmf_SH.csv", header = T, stringsAsFactors = T)
...
# model selection
write.csv(as.data.frame(anova(null.soc, red.soc, full.soc, test = "Chisq")), "res/ppk23IPIs_single_females_interaction_index_chisq.csv")
...
write.csv(combined_df, "res/ppk23IPIs_single_females_interaction_index_coeffs_table.csv")
